...
class SchoolReportContainer extends Component {
    ...
    handleDimension(reportType, minData, dimension) {
        ...
        if (dimension === 'knowledge') {
            modifiedDimensionData.dimensionTitle = '学校知识维度的表现情况';
        } else if (dimension === 'skill') {
            modifiedDimensionData.dimensionTitle = '学校技能维度的表现情况';
        } else if (dimension === 'ability') {
            modifiedDimensionData.dimensionTitle = '学校能力维度的表现情况';
        }
    ...
    handleChlidrenBasicData(reportType, data) {
        ...
        modifiedData.blockTitle = '各班级表现情况';
    ...
    handleReportStandardLevelData(reportType, mainData, optionalData) {
        ...
        modifiedData.blockTitle ='各班级各分数段表现情况'
    ...
    handleWrongQuize(reportType, datas) {
        ...
        modifiedData.blockTitle = '学校答题情况';
    ...
    handleSchoolIndicatorsInfo(reportType, data) {
        ...
        modifiedData.blockTitle = '各班级各指标表现情况';
