...
class BlockItemToWord extends React.Component {
    ...
    outPut(event) {
        ...
        setTimeout(function () {
            ...
            let nonprinting = $html.find('.noprinting');
            ...
            let html = $html.html();
            let converted = htmlDocx.asBlob(html, {margins: {top: 0, bottom: 0, right: 0, left: 0}});
    ...
    convertImageToBase64(contentDocument) {
        ...
        console.log('regularImage', regularImage);
    ...
    convertCanvasToBase64(contentDocument) {
        ...
        console.log('regularCanvas',regularCanvas);
        console.log('regularCanvas',regularCanvas[0]);
    ...
    render() {
        ...
        return (
            <div className='toWord noprinting' style={style} onClick={this.outPut.bind(this)}
