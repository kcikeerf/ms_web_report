...
class DashBoardOtherContainer extends React.Component {
    constructor() {
        super();
        this.state = {
            testList: null,
    ...
    handleTestStats(selectedAccessToken, testList, userRole) {
        ...
        for (let i in testList) {
            ...
            if (userRole === config.USER_ROLE_PUPIL) {
                ...
                let reprtStatsPromise = $.post(reprtStatsApi, reprtStatsData);

                reprtStatsPromise.done(function (response) {
...
DashBoardOtherContainer.contextTypes = {
    router: PropTypes.object.isRequired,
    handleReportIframeShow: PropTypes.func
};

export default DashBoardOtherContainer;